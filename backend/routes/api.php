...
Route::prefix('dev')->group(function () {
    ...
    Route::get('/stock-transactions/finance-summary', [StockTransactionController::class, 'financeSummary']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('stock-transactions')->group(function () {
        ...
        Route::get('/finance-summary', [StockTransactionController::class, 'financeSummary']);
        ...
        Route::get('/kartu-stok/{productId}', [StockTransactionController::class, 'getKartuStok']);
